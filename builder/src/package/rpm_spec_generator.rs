...
impl RpmSpecGenerator {
        ...
        S: AsRef<OsStr>,
    {
        ...
        #[inline(always)]
        fn write_line2<W: Write, S: AsRef<OsStr>, T: AsRef<OsStr>>(
            w: &mut W,
            s: S,
            t: T,
        ) -> std::io::Result<()> {
        ...
        write_line2(
            w,
            "%global pkg_name              ",
            Self::parse_pkg_name(patch_info),
        )?;
        ...
        write_line2(
            w,
            "%global pkg_requires          ",
            Self::parse_requires(patch_info),
        )?;
        ...
        write_line2(
            w,
            "%global patch_root            ",
            Self::parse_patch_root(patch_info),
        )?;
    ...
    pub fn generate_spec_file<P: AsRef<Path>, Q: AsRef<Path>>(
        patch_info: &PatchInfo,
        source_dir: P,
        output_dir: Q,
        ...
        let writer = LineWriter::new(fs::create_file(&pkg_spec_path)?);
