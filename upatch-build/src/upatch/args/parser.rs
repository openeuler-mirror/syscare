...
impl ArgParser<'_, OsString> for ArgParserImpl {
    fn parse_arg(matches: &ArgMatches<'_>, arg_name: &str) -> Result<OsString> {
        let value = matches
            .value_of_os(arg_name)
            .map(OsString::from)
            .with_context(|| format!("Argument \"{}\" is not present", arg_name))?;
    ...
    fn parse_args(matches: &ArgMatches<'_>, arg_name: &str) -> Result<Vec<OsString>> {
        let values = matches
            .values_of_os(arg_name)
            .with_context(|| format!("Argument \"{}\" is not present", arg_name))?;
...
impl ArgParser<'_, LevelFilter> for ArgParserImpl {
    fn parse_arg(matches: &ArgMatches<'_>, arg_name: &str) -> Result<LevelFilter> {
        let value = matches
            .value_of_lossy(arg_name)
            .with_context(|| format!("Argument \"{}\" is not present", arg_name))?;
    ...
    fn parse_args(matches: &ArgMatches<'_>, arg_name: &str) -> Result<Vec<LevelFilter>> {
        let values = matches
            .values_of_lossy(arg_name)
            .with_context(|| format!("Argument \"{}\" is not present", arg_name))?;
